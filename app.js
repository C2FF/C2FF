...
const I18N = {
  ...
  nl: {
    ...
    to_ai_bad: 'AI ANALYSE mislukt', w_me: 'OPERATOR',
  ...
  tr: {
    ...
    to_ai_bad: 'YZ ANALİZİ başarısız', w_me: 'OPERATOR',
  ...
  no: {
    ...
    to_ai_bad: 'KI-ANALYSE feilet', w_me: 'OPERATOR',
  ...
  da: {
    ...
    to_ai_bad: 'AI-ANALYSE fejlede', w_me: 'OPERATOR',
    w_claude: 'CLAUDE', w_ia: 'AI',
    w_launch: '⚡ LANCERING'
  },
  ...
  fa: {
    ...
    to_ai_bad: 'تحلیل هوش مصنوعی شکست خورد', w_me: 'OPERATOR',
  ...
  ur: {
    ...
    to_ai_bad: 'ہوش مصنوعی تجزیہ ناکام', w_me: 'OPERATOR',
  ...
  ro: {
    ...
    to_ai_bad: 'ANALIZĂ IA eșuată', w_me: 'OPERATOR',
  ...
  bg: {
    ...
    to_ai_bad: 'ИИ АНАЛИЗ се провали', w_me: 'OPERATOR',
  ...
  sl: {
    ...
    to_ai_bad: 'AI ANALIZA neuspešna', w_me: 'OPERATOR',
    w_claude: 'CLAUDE', w_ia: 'AI',
    w_launch: '⚡ ZAGON'
  },
  ...
  lt: {
    ...
    to_ai_bad: 'AI ANALIZĖ nepavyko', w_me: 'OPERATOR',
    w_claude: 'CLAUDE', w_ia: 'AI',
    w_launch: '⚡ PALEIDIMAS'
  },
  ...
  vi: {
    ...
    to_ai_bad: 'PHÂN TÍCH AI thất bại', w_me: 'OPERATOR',
    w_claude: 'CLAUDE', w_ia: 'AI',
    w_launch: '⚡ KHỞI CHẠY'
  },
};
...
document.addEventListener('keydown', e => {
  ...
  const m = { '1': 'live', '2': 'findings', '3': 'programs', '4': 'hunt', '5': 'ai', '6': 'team', '7': 'term', '8': 'chat' }[e.key];
  if (m) setTab(m);
});
